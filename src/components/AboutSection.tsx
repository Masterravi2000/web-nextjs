      ...
      <div className='w-full border border-[#181818] justify-center flex p-8 py-20'>
        <div className='w-[80%]'>
          <a className='text-white text-2xl font-bold'>
            Software Engineer skilled in Java, JavaScript, React Native, React.js, TypeScript, Redux Toolkit, Docker, and the MERN stack, with experience building scalable, high-performance applications and RESTful APIs. Focused on clean coding, reusability, security, system reliability, and delivering polished, production-ready user experiences.
          </a>
        </div>
      </div>
    </div>
